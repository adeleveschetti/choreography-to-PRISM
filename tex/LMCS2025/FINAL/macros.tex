...
% ---- Review markup for camera-ready fixes (toggle off for final) ---
% \reviewmarkstrue: additions in red, deletions struck through in red.
% \reviewmarksfalse: additions plain black, deletions disappear.
\newif\ifreviewmarks
\reviewmarkstrue
\newcommand{\rmadd}[1]{\ifreviewmarks{\color{red}#1}\else#1\fi}
\newcommand{\rmdel}[1]{\ifreviewmarks{\color{red}\sout{#1}}\fi}
% --------------------------------------------------------------------

...
\paragraph{Assumption.} We assume that every writable choreography is
such that, for every interaction $\interact{\nr}{\nr_1,\ldots,\nr_n}$,
all updates in each $u_j$ are assignments to variables located at
$\nr, \nr_1,\ldots,\nr_n$.

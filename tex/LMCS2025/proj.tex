...
Moreover, we extend a state with special variables $s_{\nr}$, one for
each module that we are considering in a given choreography.
%
The intuition is to use this variable to store the state of the

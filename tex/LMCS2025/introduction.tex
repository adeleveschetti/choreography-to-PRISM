...
\textcolor{blue}{
In the PRISM notation, the prime symbol (e.g. $x'$, $y'$) 
indicates the next-state value of the corresponding variable, 
that is, the value it will take after the transition occurs. }

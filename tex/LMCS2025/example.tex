...
\begin{lstlisting}[style=prism-color,% caption={A PRISM example},captionpos=b,
  ...
  rates \codeprism{lambda}, \codeprism{mu}, and \codeprism{theta}; the
  \codeprism{CheckOut} process transitions between two states (0 or
  1):
...
as \codeprism{lambda}, \codeprism{mu}, and \codeprism{theta},

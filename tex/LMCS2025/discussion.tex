...
% In this section, we discuss the choices made in the development of the choreographic language for modelling and analysing concurrent probabilistic systems as presented in this paper. 
%
...
representation of system behaviours,
% However, while this abstraction facilitates intuitive modelling, it
% also introduces the risk of oversimplification. Certain aspects in
% the behaviour of concurrent probabilistic systems may be lost during

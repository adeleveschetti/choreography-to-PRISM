...
For example, \texttt{[] s=0 -> 0.5 : (s'=1) + 0.5 : (s'=2);} means that when the system is in state 0 (i.e., the die hasn't been rolled yet), there is a 50\% chance it will transition to state 1 (die rolls a 1) and a 50\% chance it will transition to state 2 (die rolls a 2).

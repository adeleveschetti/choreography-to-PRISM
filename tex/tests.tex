...
\end{wrapfigure} 
\end{comment}
We now present the Hybrid Casper Protocol as modeled in PRISM \cite{DBLP:journals/distribledger/GallettaLMV23}. The Hybrid Casper protocol represents a hybrid consensus protocol for blockchains, merging features from both Proof of Work and Proof of Stake protocols. 

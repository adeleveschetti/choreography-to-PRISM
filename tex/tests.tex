...
\subsection{The Dice Program}
 ...
 In particular, the PRISM model uses two variables: \codeprism{d} which represents the value of the dice, ranging from 0 to 6; \codeprism{STATE} which is the state variable, ranging from 0 to 7.
